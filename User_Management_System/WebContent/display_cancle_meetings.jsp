...
<body>
   	...
   	<br>
   	<h1 style="margin-left:1em; font-family:'Montserrat'; font-weight:800">Cancled Meetings</h1>
        <hr><br>
    <% 
    		List <MeetingRequest> mr3 =(List<MeetingRequest>)request.getAttribute("u");
    		if(!mr3.isEmpty()){
 ...
 <table>
  ...
  <%
  	  List <MeetingRequest> mr =(List<MeetingRequest>)request.getAttribute("u");
 ...
 <% }
  ...
  %>
		...
		<h4 style="text-align: center; color:red; margin-top:180px">No Meeting cancled by client</h4>	
		<%} %>
			
			
			<div style="align-self:flex-end; margin-top:1em; margin-bottom:10px; margin-right: 4em; text-align:center;">
