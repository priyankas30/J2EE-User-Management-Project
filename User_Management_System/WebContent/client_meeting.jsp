...
<body>
 ...
 <% 
     ...
     %>
        <h1 style="color: black; font-family: cursive" >Send Meeting to Client</h1>
        <%}
        ...
        %>
         ...
         <h1 style="color: red;font-family: cursive;"> Sorry!! for this day you have another meating with another client</h1>
...
%>
	<spr:form action="send_request_client.umng" method="post" commandName="adminRequest">
